	...
	<nav class="navbar navbar-default" role="navigation" >
		<div class="collapse navbar-collapse navbar-ex1-collapse header_top">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dorpdown"><a href="index.php?view=thanhtoan"><span class="glyphicon glyphicon-usd"></span>Thanh toán</a></li>
				<li class="dorpdown"><a href="index.php?view=cartlist"><span class="glyphicon glyphicon-shopping-cart"></span>Giỏ hàng</a></li>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="" method="post">
											...
											<center><button type="submit" class="btn btn-primary" id="login" name="login">Đăng nhập</button>
